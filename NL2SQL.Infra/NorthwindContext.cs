...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<DemoCategory> DemoCategories { get; set; }

    public virtual DbSet<DemoColor> DemoColors { get; set; }

    public virtual DbSet<DemoName> DemoNames { get; set; }

    public virtual DbSet<DemoProduct> DemoProducts { get; set; }

    public virtual DbSet<DemoProduct1> DemoProducts1 { get; set; }
    ...
    public virtual DbSet<ProductWithCatAndSupp> ProductWithCatAndSupps { get; set; }
    ...
    public virtual DbSet<StringTest> StringTests { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=(localdb)\\tsql;Initial Catalog=Northwind;Integrated Security=True;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClientNr);

            entity.Property(e => e.ClientNr)
                .ValueGeneratedNever()
                .HasColumnName("clientNr");
        ...
        modelBuilder.Entity<DemoCategory>(entity =>
        {
        ...
        modelBuilder.Entity<DemoName>(entity =>
        {
            ...
            entity.Property(e => e.Name)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasDefaultValue("Stijn");
        });

        modelBuilder.Entity<DemoProduct>(entity =>
        {
            entity.HasKey(e => e.ProductId);

            entity.ToTable("DemoProduct");

            entity.Property(e => e.ProductId).ValueGeneratedNever();
            entity.Property(e => e.ProductName).HasMaxLength(50);
        });

        modelBuilder.Entity<DemoProduct1>(entity =>
        {
            entity.HasKey(e => e.ProductId);

            entity.ToTable("DemoProducts");
        ...
        modelBuilder.Entity<ProductWithCatAndSupp>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProductWithCatAndSupp");
        ...
        modelBuilder.Entity<StringTest>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("StringTest");

            entity.Property(e => e.TestStringColumn)
                .HasMaxLength(30)
                .IsFixedLength();
        });
